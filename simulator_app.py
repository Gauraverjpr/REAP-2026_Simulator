...
def custom_metric(label, value, delta=None):
    ...
    return f"""
    <div style="background-color: #FFFFFF; padding: 20px; border-radius: 12px; box-shadow: 0 4px 8px rgba(212, 175, 55, 0.15); border: 2px solid {gold_accent}; border-top: 6px solid #0A192F; margin-bottom: 15px;">
                ...
                * **Priority: D.Voc:** Percentage obtained in D.Voc.
                ...
                if os.path.exists("Priority_Rules.pdf"):
                    with open("Priority_Rules.pdf", "rb") as pdf_file:
                        pdf_b64 = base64.b64encode(pdf_file.read()).decode()
                        button_html = f'''
                        <a href="data:application/pdf;base64,{pdf_b64}" download="Priority_Rules.pdf" style="display: inline-block; padding: 0.5rem 1rem; color: #FFFFFF; background-color: #112240; border: 1px solid #D4AF37; border-radius: 6px; text-decoration: none; font-weight: 600; text-align: center; margin-top: 10px;">
                            📥 Download Official Priority Rules PDF
                        </a>
                        '''
                        st.markdown(button_html, unsafe_allow_html=True)
